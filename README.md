...
`GET /api/n5-kanji` — no query params; returns the whole seeded N5 kanji pool (`{ success, data: N5Kanji[], count, timestamp }`) for the `/learn` lesson pages' kanji breakdowns.
