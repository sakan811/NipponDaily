...
describe('GeminiService', () => {
  ...
  describe('chatAboutNews', () => {
    it('should throw error when client is not initialized', async () => {
      ...
      await expect(service.chatAboutNews('test', [])).rejects.toThrow('Gemini client not initialized')
    })
    ...
    it('should generate chat response with news context', async () => {
      ...
      const result = await service.chatAboutNews('What is this news about?', mockNews)
    ...
    it('should handle API errors in chat', async () => {
      ...
      await expect(service.chatAboutNews('test', [])).rejects.toThrow('Failed to process chat message')
    })
  })
  ...
  describe('summarizeNews', () => {
    it('should throw error when client is not initialized', async () => {
      ...
      await expect(service.summarizeNews(newsItem)).rejects.toThrow('Gemini client not initialized')
    })
    ...
    it('should generate news summary', async () => {
      ...
      const result = await service.summarizeNews(newsItem)
