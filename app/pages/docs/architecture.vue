  ...
  <UPage>
    ...
    <main class="max-w-4xl mx-auto py-8 px-4 prose dark:prose-invert">
      ...
      <p class="mb-8 text-gray-700 dark:text-gray-300">
        ...
        scalability, and AI integration. The following diagram illustrates the
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
        <UCard>
          ...
          <p class="text-sm">
            Built with Nuxt 4, using Nuxt UI v4 for components and Tailwind CSS
            v4 for styling. It provides a responsive and fast user interface.
          </p>
        </UCard>
        ...
        <UCard>
          ...
          <p class="text-sm">
            The server-side logic runs on Nitro, providing high-performance API
            routes and seamless integration with external services.
          </p>
        </UCard>
        ...
        <UCard>
          ...
          <p class="text-sm">
            Redis-based rate limiting via Upstash ensures fair usage and
            prevents API abuse.
          </p>
        </UCard>
      </div>
      ...
      <p>
        The app uses Nuxt UI v4's semantic color system with Tailwind v4's
        native palette:
      </p>
        ...
        <table class="min-w-full border-collapse">
          ...
          <tbody class="divide-y divide-gray-200 dark:divide-gray-800">
            <tr>
              ...
              <td class="py-2 px-4">Main CTAs, selected buttons</td>
            </tr>
            <tr>
              <td class="py-2 px-4">Secondary</td>
              <td class="py-2 px-4"><code>sky</code></td>
              <td class="py-2 px-4">
                Secondary buttons, outline buttons, muted text
              </td>
            </tr>
            <tr>
              <td class="py-2 px-4">Success</td>
              <td class="py-2 px-4"><code>amber</code></td>
              <td class="py-2 px-4">Success messages, sports category</td>
            </tr>
            <tr>
              <td class="py-2 px-4">Info</td>
              <td class="py-2 px-4"><code>sky</code></td>
              <td class="py-2 px-4">Info alerts, technology category</td>
            </tr>
            <tr>
              <td class="py-2 px-4">Warning</td>
              <td class="py-2 px-4"><code>amber</code></td>
              <td class="py-2 px-4">Warning messages, culture category</td>
            </tr>
            <tr>
              <td class="py-2 px-4">Error</td>
              <td class="py-2 px-4"><code>orange</code></td>
              <td class="py-2 px-4">Error messages, politics category</td>
            </tr>
            <tr>
              <td class="py-2 px-4">Neutral</td>
              <td class="py-2 px-4"><code>stone</code></td>
              <td class="py-2 px-4">Fallback category, disabled states</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div class="overflow-x-auto my-6">
        <table class="min-w-full border-collapse">
          ...
          <tbody class="divide-y divide-gray-200 dark:divide-gray-800">
            <tr>
              <td class="py-2 px-4">Politics</td>
              <td class="py-2 px-4">Error</td>
              <td class="py-2 px-4">orange</td>
            </tr>
            <tr>
              <td class="py-2 px-4">Business</td>
              <td class="py-2 px-4">Primary</td>
              <td class="py-2 px-4">orange</td>
            </tr>
            <tr>
              ...
              <td class="py-2 px-4">Info</td>
              <td class="py-2 px-4">sky</td>
            </tr>
            <tr>
              <td class="py-2 px-4">Culture</td>
              <td class="py-2 px-4">Warning</td>
              <td class="py-2 px-4">amber</td>
            </tr>
            <tr>
              <td class="py-2 px-4">Sports</td>
              <td class="py-2 px-4">Success</td>
              <td class="py-2 px-4">amber</td>
            </tr>
            <tr>
      ...
      <blockquote
        class="border-l-4 border-primary-500 pl-4 italic my-6 text-gray-600 dark:text-gray-400"
      >
        <strong>Note</strong>: Dark mode is supported via the UColorModeButton
        component, which leverages Nuxt UI's built-in color mode support. Color
        values are dynamically adjusted by Nuxt UI for dark mode.
      </blockquote>
      ...
      <ul class="list-disc pl-6 mb-6 space-y-1">
        ...
        <li>
          75%:
          <code class="text-lime-600 dark:text-lime-400"
            >hsl(90, 70%, 45%)</code
          >
          - Yellow-Green
        </li>
        <li>
          50%:
          <code class="text-yellow-600 dark:text-yellow-400"
            >hsl(60, 70%, 45%)</code
          >
          - Yellow
        </li>
        <li>
          25%:
          <code class="text-orange-600 dark:text-orange-400"
            >hsl(30, 70%, 45%)</code
          >
          - Orange-Red
        </li>
        <li>
          0%:
          <code class="text-red-600 dark:text-red-400">hsl(0, 70%, 45%)</code> -
          Red
        </li>
      </ul>
      <p>
        The credibility score uses a dynamic gradient computed as
        <code>hue = score × 120</code> (score 0-1).
      </p>
    </main>
