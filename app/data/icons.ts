// Heroicons-style outline paths, keyed by the name after the `i-<set>-`
// prefix. Built once per module, not per render. test/unit/icons.test.ts
// fails if the app references a name that is missing here.
...
// Shown for an unknown name.
export const FALLBACK_ICON = `<circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="12" x2="16" y2="12"/>`;
